...
# Usage: bash run_test_rfdetr_native.sh [skip=3] [conf=0.35] [weights=runs/rfdetr/checkpoint_best_total.pth]
set -e
...
OUT="output/submission_native_skip${SKIP}_conf${CONF}_${TAG}.csv"
