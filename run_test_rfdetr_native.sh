...
# Usage: bash run_test_rfdetr_native.sh [skip=3] [conf=0.35] [weights=...] [fusion_mode=vote|noisy_or]
set -e
...
OUT="output/submission_native_skip${SKIP}_conf${CONF}_${FUSION_MODE}_${TAG}.csv"
